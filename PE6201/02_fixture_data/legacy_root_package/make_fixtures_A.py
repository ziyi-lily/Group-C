...
EXTRA_PROCEDURES = [
    {"code": "91999", "description": "CT chest without contrast", "requires_preauth": True},
]          # {"code", "description", "requires_preauth"}

EXTRA_HOSPITALS = [
    {"hospital_id": "H-512", "name": "Singapore Heart Institute", "panel": True, "country": "SG"},
    {"hospital_id": "H-624", "name": "Kuala Lumpur General", "panel": False, "country": "MY"},
]				# {"hospital_id", "name", "panel", "country"}

EXTRA_POLICIES = [
    {   "policy_id": "POL-8144", "product": "Shield Gold", "status": "active",
        "start_date": "2026-01-01", "end_date": "2026-12-31",
        "annual_limit": 20000, "used_to_date": 17000,
        "exclusions": [{"code": "31255", "rule": "EX-14 cosmetic dermatology"}]},
    {   "policy_id": "POL-8191", "product": "Shield Gold", "status": "active",
        "start_date": "2026-01-01", "end_date": "2026-12-31",
        "annual_limit": 20000, "used_to_date": 4500,
        "exclusions": [{"code": "31255", "rule": "EX-14 cosmetic dermatology"}]},
...
EXTRA_MEMBERS = [
    {"member_id": "M-7181", "name": "Sarah Tan", "policy_id": "POL-8144", "join_date": "2024-06-15"},
    {"member_id": "M-7192", "name": "Ahmad Razak", "policy_id": "POL-8191", "join_date": "2023-11-20"},
]				# {"member_id", "name", "policy_id", "join_date"}

EXTRA_PREAUTHORISATIONS = [
    {"preauth_id": "PA-9101", "member_id": "M-7181", "procedure_code": "91999",
     "valid_from": "2026-08-01", "valid_to": "2026-10-31"},
]  				# {"preauth_id", "member_id", "procedure_code",
				#  "valid_from", "valid_to"}

EXTRA_CLAIMS = [
    {"claim_id": "CLM-9013", "member_id": "M-5502", "hospital_id": "H-207",
             "date_of_service": "2026-08-16",
             "narrative": "knee replacement, routine outpatient consultation and diagnostic colonoscopy",
             "documents": ["itemised_bill", "discharge_summary"],
             "lines": [{"code": "27447", "amount": 400},
                       {"code": "99213", "amount": 370},
                       {"code": "45378", "amount": 230}]},
    {"claim_id": "CLM-9014", "member_id": "M-5502", "hospital_id": "H-207",
                  "date_of_service": "2026-09-12",
                  "narrative": "Comprehensive metabolic panel, blepharoplasty, routine outpatient consultation and diagnostic colonoscopy",
                  "documents": ["itemised_bill"],
                  "lines": [{"code": "80053", "amount": 550},
                            {"code": "15823", "amount": 668},
                            {"code": "99213", "amount": 370},
                            {"code": "45378", "amount": 230}]},               
    {"claim_id": "CLM-9015", "member_id": "M-5502", "hospital_id": "H-207",
                      "date_of_service": "2026-09-12",
                      ...
                      "lines": [{"code": "80053", "amount": 190},
                                {"code": "15823", "amount": 500},
                                {"code": "99213", "amount": 370},
                                {"code": "27447", "amount": 7800}]},
    {"claim_id": "CLM-9016", "member_id": "M-6118", "hospital_id": "H-207",
             "date_of_service": "2026-04-16",
             "narrative": "Laparoscopic appendicectomy and Knee arthroscopy",
             "documents": [],
             "lines": [{"code": "47120", "amount": 5300},
                       {"code": "29881", "amount": 1500}]},
    {"claim_id": "CLM-9017", "member_id": "M-6118", "hospital_id": "H-207",
             "date_of_service": "2026-02-19",
             "narrative": "Comprehensive metabolic panel",
             "documents": [],
             "lines": [{"code": "80053", "amount": 6801}]},
    {"claim_id": "CLM-9018", "member_id": "M-2214", "hospital_id": "H-114",
...
EXTRA_DECIDED = [
    {
        "claim_id": "CLM-9101", "member_id": "M-7192", "hospital_id": "H-512",
        "date_of_service": "2026-09-10",
        "lines": [{"code": "91999", "amount": 850}],
        "decision": "approve_in_principle", "decided_on": "2026-09-12"
    }
]				# {"claim_id", "member_id", "hospital_id",
...
# Load the third group member's eight additional cases.
import runpy as _runpy
_GROUP3_FIXTURES = _runpy.run_path(
    os.path.join(HERE, "8_new_cases.py")
)
EXTRA_CLAIMS.extend(
    _GROUP3_FIXTURES["EXTRA_CLAIMS"]
)
EXTRA_DECIDED.extend(
    _GROUP3_FIXTURES["EXTRA_DECIDED"]
)


# _NEGATIVE_LIMIT_CLEANUP
EXTRA_CLAIMS[:] = [
    row for row in EXTRA_CLAIMS
    if row["claim_id"] not in {"CLM-9107", "CLM-9108"}
]

EXTRA_DECIDED[:] = [
    row for row in EXTRA_DECIDED
    if row["claim_id"] != "CLM-9100"
]
